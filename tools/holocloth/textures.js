// Procedural fabric textures. Ported from holocloth (MIT, Dmitry Kurash).
...
// Height field of a plain weave: interleaved warp/weft threads with
...
export function makeWeaveNormalMap(size = 512, threads = 64, seed = 1337) {
  return heightToNormalTexture(weaveHeight(size, threads, mulberry32(seed)), size, 1.6);
}

// Any grayscale image becomes a bump map: luminance as height.
...
// Mid-grey noise; multiplies material.roughness so matte never reads flat.
